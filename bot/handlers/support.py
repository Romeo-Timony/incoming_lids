...
START_MESSAGE = "Здравствуйте! Я помогу оформить запись на массаж. Как вас зовут?"
RESET_MESSAGE = "Диалог сброшен. Начнем заново. Как вас зовут?"
GENERIC_ERROR_MESSAGE = "Сейчас не удалось обработать заявку. Попробуйте еще раз через пару минут."
UNSUPPORTED_MESSAGE = "Пожалуйста, ответьте текстом — так я смогу заполнить анкету для записи."
...
async def handle_text_message(
    ...
    try:
        ...
        logger.exception("Failed to process incoming booking message")
